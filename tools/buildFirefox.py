...
def run():
	...
	try :
		cuddlefish.run(["--update-url", "https://thetabx.net/addon/pbe/firefox/%APP_OS%/%CURRENT_APP_VERSION%/%ITEM_VERSION%/", "xpi"])
	except SystemExit:
		print("Copy .xpi")
		distutils.file_util.copy_file("pbe.xpi", os.path.join("..", chromeDir, "build", "pbe.xpi"))
